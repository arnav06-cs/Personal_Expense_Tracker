...
def generate_report():
    ...
    add_p(
        ...
        "Science and Information Technology. Operating at the intersection of academia and industry, Infynas Learning Solutions provides intensive, "
        "project-based training programs designed to expose students to real-world software engineering paradigms, full-stack application architectures, "
        "and professional code craftsmanship."
    )
    add_p(
        ...
        "and the rapidly evolving standards of the global software industry. Rather than relying solely on abstract theoretical lectures, "
        ...
        "implement robust security measures against OWASP vulnerabilities; and utilize industry-standard Version Control Systems (VCS) like Git."
    )
    add_p(
