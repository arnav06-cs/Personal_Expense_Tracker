...
def generate_report():
    ...
    print("Original doc paragraph count:", len(doc.paragraphs))
    ...
    def add_p(text, space_before=5, space_after=6, bold=False, italic=False, font_size=11, color=RGBColor(51, 65, 85), align=WD_ALIGN_PARAGRAPH.JUSTIFY, line_spacing=1.15):
    ...
    def add_h1(text):
        return add_p(text, space_before=22, space_after=12, bold=True, font_size=16, color=RGBColor(15, 23, 42), align=WD_ALIGN_PARAGRAPH.LEFT)

    def add_h2(text):
        return add_p(text, space_before=16, space_after=8, bold=True, font_size=13.5, color=RGBColor(16, 185, 129), align=WD_ALIGN_PARAGRAPH.LEFT)

    def add_h3(text):
        return add_p(text, space_before=12, space_after=6, bold=True, font_size=12, color=RGBColor(30, 41, 59), align=WD_ALIGN_PARAGRAPH.LEFT)
    ...
    add_p(
        "Infynas Learning Solutions, Raipur is a premier technology training, research, and software skill-development institution "
        "dedicated to cultivating high-caliber engineering talent across Computer Science and Information Technology disciplines. "
        "Operating at the intersection of academia and industry, Infynas Learning Solutions provides intensive, practical, project-based "
        "training programs designed to expose undergraduate students to real-world software engineering paradigms, full-stack application "
        "architectures, and professional code craftsmanship."
    )
    add_p(
        "The core mission of Infynas Learning Solutions is to address the prevalent gap between traditional academic computer science "
        "curricula and the rapidly evolving standards of the global software industry. Rather than relying solely on abstract theory, "
        "trainees at Infynas Learning Solutions are immersed in end-to-end Agile software development lifecycles. Candidates are taught to write "
        "clean, maintainable, modular code; construct scalable relational database schemas; enforce rigorous Web Content Accessibility Guidelines (WCAG); "
    ...
    add_p(
        ...
        "over 65% of young working professionals and students encounter financial stress at the end of every month due to unmonitored discretionary spending."
    )
    add_p(
    ...
    add_h2("1.6 Report Organization Structure")
    ...
    add_h2("3.4 System Security & Data Isolation Architecture")
    ...
    add_h2("4.2 Comprehensive System Testing & Test Cases")
    add_p("System stability was verified through 10 comprehensive unit and integration test cases:")
    ...
    add_table_data(
        ...
        [
            ...
            ["TC-10", "PDF Exporter", "Click 'Export PDF' button on reports page", "Generate & download ReportLab PDF report", "PASS"]
        ]
    )
    ...
    print("Report generated and saved to:", output_path)
